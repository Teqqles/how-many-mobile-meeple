...
Widget _wrapWidget(Widget child) => MaterialApp(home: Scaffold(body: child));
  ...
  group('AppChoiceChip', () {
    testWidgets('renders label text', (tester) async {
      await tester.pumpWidget(
        _wrapWidget(
          AppChoiceChip(label: 'Test', selected: false, onSelected: (_) {}),
        ),
      );
    ...
    testWidgets('does not show checkmark', (tester) async {
      await tester.pumpWidget(
        _wrapWidget(
          AppChoiceChip(label: 'Test', selected: true, onSelected: (_) {}),
        ),
      );
